...
public class BankOfAmerica {
    public static void main(String[] args) {
        ...
        ArrayList<Tester> AutomationTeam = new ArrayList<>();
            AutomationTeam.addAll(Arrays.asList(tester1,tester2,tester3,tester4,tester5));

            AutomationTeam.removeIf(p-> !p.jobTitle.contains("SDET") );

        System.out.println(AutomationTeam.size());
        double totalBudget = 0;
        for( Tester each :  AutomationTeam){
