...
public class staticVariables2 {
    ...
    static int staticVariable;  //there is only oe copy of static shared by all objects
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(staticVariable2.insVariable); //instance CAN NOT be called through class name
